...
<template>
    <main > 
      ...
      <div
        ...
        <NuxtImg src="../static/images/logoipsum-211.svg" alt="Brand 1" width="132" height="35" />
        <NuxtImg src="../static/images/logoipsum-221.svg" alt="Brand 2" width="119" height="30" />
        <NuxtImg src="../static/images/logoipsum-225.svg" alt="Brand 3" width="49" height="48" />
        <NuxtImg src="../static/images/logoipsum-280.svg" alt="Brand 4" width="78" height="30" />
        <NuxtImg src="../static/images/logoipsum-284.svg" alt="Brand 5" width="70" height="44" />
        <NuxtImg src="../static/images/logoipsum-215.svg" alt="Brand 6" width="132" height="40" />
      </div>
