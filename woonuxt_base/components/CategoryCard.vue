...
const imgD = ref('https://wp.gamaoutillage.net/wp-content/uploads/2024/02/logoOutline.png')
//console.log(imgD)
</script>
...
<template>
  <div class=" items-center   ">
    <NuxtLink v-if="node" :to="`/product-category/${formatURI(node.slug)}`"
      ...
      <NuxtImg width="300px" height="300px" v-if="imageSrc" class=" w-fit  md:h-32 sm:h-20 max-sm:h-20  p-2 max-sm:rounded-full sm:rounded-full md:rounded-lg" :src="node.image?.src || imgD"
